...
export class CockroachDbConnection extends AbstractSqlConnection {

  async connect(): Promise<void> {
    this.patchKnex();
    this.client = this.createKnexClient('cockroachdb');
  }
  ...
  private addColumn(this: any, col: Dictionary, that: CockroachDbConnection): void {
