...
import { CockroachDbSchemaHelper } from './CockroachDbSchemaHelper';
import { CockroachDbExceptionConverter } from './CockroachDbExceptionConverter';

export class CockroachDbPlatform extends AbstractSqlPlatform {

  protected readonly schemaHelper: CockroachDbSchemaHelper = new CockroachDbSchemaHelper(this);
  protected readonly exceptionConverter = new CockroachDbExceptionConverter();
