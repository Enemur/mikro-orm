...
export class CockroachDbSchemaHelper extends SchemaHelper {
  ...
  normalizeDefaultValue(defaultValue: string, length: number) {
    ...
    return super.normalizeDefaultValue(defaultValue, length, CockroachDbSchemaHelper.DEFAULT_VALUES);
  }
